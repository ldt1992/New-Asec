<%@ Page Title="Hỏi Đáp Nhanh" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Faq.aspx.cs" Inherits="Faq" %>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 main">
                        <h2 class="bg-red"><span class="title-part">HỎI ĐÁP</span></h2>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                ...
                                <br />
                                <asp:Button ID="btnGui" runat="server" Text="GỬI CÂU HỎI" CssClass="btn btn-lg btn-danger" OnClick="btnGui_Click" ValidationGroup="Error" />
                            </div>
                        </div>
